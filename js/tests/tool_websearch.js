...
/**
 * JS counterpart of `rust/tests/tool_websearch.rs`.
 *
 * The Rust port keeps a per-tool unit test for the websearch tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/websearch.tools.js` where the tool
...
describe('tool websearch parity with Rust port', () => {
