...
/**
 * JS counterpart of `rust/tests/tool_webfetch.rs`.
 *
 * The Rust port keeps a per-tool unit test for the webfetch tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/webfetch.tools.js` where the tool
...
describe('tool webfetch parity with Rust port', () => {
