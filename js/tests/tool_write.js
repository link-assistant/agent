...
/**
 * JS counterpart of `rust/tests/tool_write.rs`.
 *
 * The Rust port keeps a per-tool unit test for the write tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/write.tools.js` where the tool
...
describe('tool write parity with Rust port', () => {
