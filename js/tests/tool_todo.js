...
/**
 * JS counterpart of `rust/tests/tool_todo.rs`.
 *
 * The Rust port keeps a per-tool unit test for the todo tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/todo.tools.js` where the tool
...
describe('tool todo parity with Rust port', () => {
