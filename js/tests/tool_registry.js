...
/**
 * JS counterpart of `rust/tests/tool_registry.rs`.
 *
 * The Rust port keeps a per-tool unit test for the registry tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/registry.tools.js` where the tool
...
const TOOL_NAME = 'registry';

describe('tool registry parity with Rust port', () => {
