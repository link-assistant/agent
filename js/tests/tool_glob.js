...
/**
 * JS counterpart of `rust/tests/tool_glob.rs`.
 *
 * The Rust port keeps a per-tool unit test for the glob tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/glob.tools.js` where the tool
...
describe('tool glob parity with Rust port', () => {
