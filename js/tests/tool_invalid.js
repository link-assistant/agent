...
/**
 * JS counterpart of `rust/tests/tool_invalid.rs`.
 *
 * The Rust port keeps a per-tool unit test for the invalid tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/invalid.tools.js` where the tool
...
const TOOL_NAME = 'invalid';

describe('tool invalid parity with Rust port', () => {
