...
/**
 * JS counterpart of `rust/tests/tool_edit.rs`.
 *
 * The Rust port keeps a per-tool unit test for the edit tool. The
 * JavaScript implementation tests each tool through its integration
 * suite (see `js/tests/integration/edit.tools.js` where the tool
...
describe('tool edit parity with Rust port', () => {
