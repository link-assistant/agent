...
The user message "read fake image with validation disabled" is used to test the CLI output behavior, particularly with environment variable `VERIFY_IMAGES_AT_READ_TOOL=false` to disable image validation.
